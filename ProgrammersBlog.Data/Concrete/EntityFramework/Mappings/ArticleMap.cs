...
namespace ProgrammersBlog.Data.Concrete.EntityFramework.Mappings
{
    public class ArticleMap : IEntityTypeConfiguration<Article>
    {
        public void Configure(EntityTypeBuilder<Article> builder)
        {
            ...
            builder.HasOne<Category>(a => a.Category).WithMany(c=>c.Articles).HasForeignKey(a=>a.CategoryId);//Bire Çok ilişki
            builder.ToTable("Articles");
            builder.HasOne<User>(a => a.User).WithMany(u => u.Articles).HasForeignKey(a => a.UserId);
            //Bir makale oluşurken hem bir categoriye hemde bir kullanıcıya ihtiyaç duyacak.
            //Ancak bir kullanıcı ve bir categori birden fazla makaleye sahip olacak.
